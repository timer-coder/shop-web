        ...
        <el-header class="top-header">
            ...
            active-text-color="#ffd04b">
                <el-menu-item index="0">
                    <el-link href="./#/home" target="_blank" style="color: #fff">主页</el-link>
                </el-menu-item>
                ...
                <el-main class="top-main">
                    ...
                    <el-header class="medium-header" height="230px">
                        <el-carousel :interval="4000" type="card" height="200px">
                            ...
                            <el-carousel-item @click.native="link()">
                                <el-link herf="http://192.168.43.187:8080/" target="_blank">链接</el-link>
                            </el-carousel-item>-->
                            <el-carousel-item>
                                <img src="http://3m123712o1.qicp.vip/file/14401390125964558353" class="image">
                            </el-carousel-item>
                            <el-carousel-item>
                                <img src="http://3m123712o1.qicp.vip/file/14401390125964558352" class="image">
                            </el-carousel-item>
                            <el-carousel-item>
                                <img src="http://3m123712o1.qicp.vip/file/14401390125964558354" class="image">
                            </el-carousel-item>
                            <el-carousel-item>
                                <img src="http://3m123712o1.qicp.vip/file/14401390125964558359" class="image">
                            </el-carousel-item>
                            <el-carousel-item>
                                <img src="http://3m123712o1.qicp.vip/file/14401390125964558357" class="image">
                            </el-carousel-item>
                            <el-carousel-item>
                                <img src="http://3m123712o1.qicp.vip/file/14401390125964558358" class="image">
                            </el-carousel-item>
                        </el-carousel>
                    </el-header>
                    <!--猜你喜欢-->
                    <el-header class="bottom-header">
                        <el-breadcrumb-item>猜你喜欢<i class="el-icon-arrow-right"></i></el-breadcrumb-item>
                    </el-header>
                    <!--推荐-->
                    <el-main>
                        <el-row>
        ...
        <el-container style="background-color: #fff">
            <el-main style="padding: 0px">
                <el-container>
                    ...
                    <!--商品推荐-->
                    <el-header height="30px" class="body-title">
                ...
                <el-container  style="background-color: rgb(239, 245, 239)">
                    ...
                    <el-header height="30px">
                        <i class="el-icon-arrow-right"></i>
                        <el-breadcrumb-item>百货</el-breadcrumb-item>
                    </el-header>
                    <!--信息卡片-->
                    <el-main>
                        <el-row>
                ...
                <el-container style="background-color: #fff">
                    ...
                    <el-header height="30px">
                        <i class="el-icon-arrow-right"></i>
                        <el-breadcrumb-item>鞋包</el-breadcrumb-item>
                    </el-header>
                    <!--信息卡片-->
                    <el-main>
                        <el-row>
                ...
                <el-container style="background-color: #fff">
                    ...
                    <el-header height="30px">
                        <i class="el-icon-arrow-right"></i>
                        <el-breadcrumb-item>数码电器</el-breadcrumb-item>
                    </el-header>
                    <!--信息卡片-->
                    <el-main>
                        <el-row>
                ...
                <el-container  style="background-color: rgb(239, 245, 239)">
                    ...
                    <el-header height="30px">
                        <i class="el-icon-arrow-right"></i>
                        <el-breadcrumb-item>美妆/洗护</el-breadcrumb-item>
                    </el-header>
                    <!--信息卡片-->
                    <el-main>
                        <el-row>
                ...
                <el-container style="background-color: #fff">
                    ...
                    <el-header height="30px">
                        <i class="el-icon-arrow-right"></i>
                        <el-breadcrumb-item>运动</el-breadcrumb-item>
                    </el-header>
                    <!--信息卡片-->
                    <el-main>
                        <el-row>
...
export default {
  ...
  created () {
    ...
    axios.get('http://3m123712o1.qicp.vip/goods/68')
      .then(function (response) {
        console.log(response.data.data.goods.name)
        that.goodsnamesecond = response.data.data.goods.name
        console.log(response.data.data.goods.mainDescribe)
        that.goodsdescribesecond = response.data.data.goods.mainDescribe
        console.log(response.data.data.goods.mainurl)
        that.goodsmainurlsecond = response.data.data.goods.mainurl
      })
      .catch(function (error) {
        alert(error)
      })
